...
\end{figure}
	...
	Another consideration we made when finalising the requirements of our simulation was how we could model real-life scenarios. All of the members of our team had agreed that we wanted one of the options for a user to be a multi-lane roundabout. However, there we foresaw several problems in implementing it. 
