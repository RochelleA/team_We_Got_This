...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{figure}[h]
		...
		\begin{subfigure}{0.45\textwidth}
			\centering
			\includegraphics[width=\textwidth]{MVCExample.jpg}
...
\subsubsection{Project Timetabling}
